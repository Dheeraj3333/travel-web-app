...
const DomesticHolidayForm = () => {
  interface DomesticHolidayFormData {
    city: string
    holiday: string
    type:string
  }
  ...
  const [data, setData] = useState<DomesticHolidayFormData>(initialStateOfData)
  ...
  return (
    <div className="bg-background px-6 max-sm:px-2 pb-6 ">
      <h2 className="text-xl font-semibold mb-4 text-gray-700">Search Domestic holidays.</h2>
...
export default DomesticHolidayForm