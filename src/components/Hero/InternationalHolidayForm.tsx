...
const InternationalHolidayForm = () => {
  interface InternationalHolidayFormData {
    type: string;
    city: string;
    holiday: string;
  }
  ...
  const [data, setData] =
    useState<InternationalHolidayFormData>(initialStateOfData);
...
export default InternationalHolidayForm;